...
function addMore() {
    let another_modal = `
        ...
        <div class="mb-3">
            ...
            <a href="#" class="btn btn-danger song-action-btn" id="song-remove-btn" onclick="removeMore()"><i class="bi bi-trash"></i> remove</a>
        </div>
    `;
...
function removeMore() {
    document.getElementById("song-id").parentElement.remove();
}